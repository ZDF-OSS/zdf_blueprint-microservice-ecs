...
export class EcsBpMicroservice extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const imageAsset = new cdk.aws_ecr_assets.DockerImageAsset(this, `${product}-image`, {
    ...
    const task = new cdk.aws_ecs.FargateTaskDefinition(
      this,
      `${product}-td`,
      {
        memoryLimitMiB: 512,
    ...
    const sercvice = new cdk.aws_ecs.FargateService(
      this,
      `${product}-service`,
      {
        cluster,
